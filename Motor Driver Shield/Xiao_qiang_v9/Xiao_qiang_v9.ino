/*
  ...
  m2_P = 1.105, m2_I = 0.0001, m2_D = 0.001;
...
unsigned long timeout_interval = 10000;
...
double m2_P = 1.10, m2_I = 0.0001, m2_D = 0.001;
double m1_P = 1.06, m1_I = 0.0001, m1_D = 0.001;
String commandBuffer = ""; // 71277776377627
boolean sendSensorReading=false, explorationMode=false;
...
void loop(){
  switch(command){
    case 0:  // idle state, send readings once and check if there is next command
      ...
      if(explorationMode && ((millis()-last_received_time)>timeout_interval)){
        Serial.println("pc:nak");
    ...
    case 1: // move 1 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<225;){
        moveForward();
    ...
    case 50: // move 3 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<780;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
    ...
    case 52: // move 5 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<1380;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
    ...
    case 53: // move 6 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<1680;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
    ...
    case 54: // move 7 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<2000;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
    ...
    case 55: // move 8 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<2320;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
    ...
    case 56: // move 9 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<2640;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
    ...
    case 57: // move 10 grid
      ...
      targetSpeed = 600;
      for(m2MovementCount=0, m1MovementCount=0, m1Ticks=0, m2Ticks=0, avgCount=0; avgCount<2920;){
        moveForward();
        avgCount = (m2MovementCount+m1MovementCount)/2;
      }
      // Setting wheels to brake
...
void obstacleIdentification(){
  ...
  if(explorationMode&&sendSensorReading){
    Serial.print("pc:");
